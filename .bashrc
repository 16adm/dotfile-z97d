...
if [[ $PS1 && -f /usr/share/git/git-prompt.sh ]]; then
	...
	export PS1="$Y\D{%F %T}\n$GY[$Y\u$GY@$P\h$GY:$B\W\$(__git_ps1 \"$GY|$LB%s\")$GY]$W\$(get_prompt_symbol) "
else
...
alias jp='expressvpn connect jpyo'
alias vpns='expressvpn status'
alias vpnd='expressvpn disconnect'

# DOOM_EMACS
export PATH=/home/shieh/.emacs.d/bin:$PATH
alias doomsy='doom sync'
alias doomug='doom upgrade'
alias doomud='doom update'
alias doomck='doom doctor'
...
#  . /usr/lib/python3.6/site-packages/powerline/bindings/shell/powerline.sh
#fi
#if [ -f ~/.Xmodmap ]; then
#	xmodmap ~/.Xmodmap;
#fi
